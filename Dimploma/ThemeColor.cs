...
namespace Dimploma
{
    public static class ThemeColor
    {
        ...
        public static string LightPurple = "#E9E8FC";
        public static string LightBlue = "#E9F1FD";
       ...
       public static string Blue = "#1678F3";

        // colors for btns
       public static string VioletDark = "#4840EC";
       public static string BlueDark = "#558EEE";
